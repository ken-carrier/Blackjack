...
namespace Blackjack.Extensions
{
    public class GameExtension
    {
        ...
        public static DealOutcome GetDealOutcome(Player player)
        {
            DealOutcome outcome = DealOutcome.Under21;
            if (player.Score > 21 && !GameExtension.HasAces(player))
            {
                outcome = DealOutcome.Over21;
            }
            if (player.Score == 21)
            {
                outcome = DealOutcome.At21;
            }
            return outcome;
        }

        public static DealOutcome GetLeftDealOutcome(Player player)
        {
            DealOutcome outcome = DealOutcome.Under21;
            ...
            if (player.SplitDeck.ScoreLeft == 21)
            {
                outcome = DealOutcome.At21;
            }
            return outcome;
        ...
        public static DealOutcome GetRightDealOutcome(Player player)
        {
            DealOutcome outcome = DealOutcome.Under21;
            ...
            if (player.SplitDeck.ScoreRight == 21)
            {
                outcome = DealOutcome.At21;
            }
            return outcome;
